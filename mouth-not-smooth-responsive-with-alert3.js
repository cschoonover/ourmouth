...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-0.8,-0.4,1,1,0,0,0,769.2,1011.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(-768.5,-335.5,1537,671), null);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.MouthPoses("single",0);
	this.instance.parent = this;
	this.instance.setTransform(-1.3,-5.4,1,1,0,0,0,769.2,1011.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(-561.5,-286.5,1123,573), null);
...
(lib.mouthnotsmoothresponsivewithalert3 = function(mode,startPosition,loop) {
	...
	this.movieClip_2.setTransform(769.3,1022.4);
	...
	this.movieClip_1.setTransform(769.8,1027.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.movieClip_2}]}).to({state:[{t:this.instance}]},34).to({state:[{t:this.instance}]},2).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},4).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},3).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},3).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},2).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},2).to({state:[{t:this.instance}]},2).to({state:[{t:this.instance}]},2).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},2).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.movieClip_1}]},5).wait(13));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(34).to({_off:false},0).wait(2).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(4).to({startPosition:2},0).wait(1).to({startPosition:1},0).wait(3).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(3).to({startPosition:2},0).wait(1).to({startPosition:1},0).wait(2).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:1},0).wait(2).to({startPosition:2},0).wait(2).to({startPosition:3},0).wait(2).to({startPosition:3},0).wait(1).to({startPosition:2},0).wait(2).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:1},0).to({_off:true},5).wait(13));
